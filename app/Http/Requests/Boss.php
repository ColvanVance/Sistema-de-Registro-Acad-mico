...
class Boss extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'identification' => ['required', 'string', 'max:14', Rule::unique('bosses')->ignore($this->boss->id ?? null)],
            'number_phone' => ['required', 'string', 'max:10', Rule::unique('bosses')->ignore($this->boss->id ?? null)],
            'email' => ['required', 'email', 'max:255', Rule::unique('bosses')->ignore($this->boss->id ?? null)],
