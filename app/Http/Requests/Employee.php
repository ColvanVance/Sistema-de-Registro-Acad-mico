...
class EmployeeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'number_phone' => ['required', 'string', 'max:10', Rule::unique('employees')->ignore($this->employee->id ?? null)],
            'emergency_contact_phone' => 'required'|'string'|'max:10',
            'emergency_contact_name' => 'required|string|max:255',
            'email' => ['required', 'email', 'max:255', Rule::unique('employees')->ignore($this->employee->id ?? null)],
            'nacionality' => 'required|string|max:100',
            'educative_level' => 'required|string|max:100',
            'identification' => ['unique', 'string', 'max:50', Rule::unique('employees')->ignore($this->employee->id ?? null)],
    ...
    public function messages(): array
    {
        return [
            ...
            'date_of_birth.before_or_equal' => 'La fecha de nacimiento no puede ser una fecha futura.',
            ...
            'email.string' => 'El correo electrónico debe contener solo caracteres.',
            ...
            'identification.max' => 'La identificación tiene un máximo de 50 caracteres.',
            'identification.unique' => 'La identificación ya está en uso.',

            'address.required' => 'La dirección es obligatoria.',
            'address.text' => 'La dirección debe contener solo caracteres.',
            'address.min' => 'La dirección tiene un minimo de 10 caracteres.',
            'address.max' => 'La dirección tiene un máximo de 500 caracteres.',
            ...
            'departament.exists' => 'El departamento seleccionado no es válido.',
        ];
    }
}
