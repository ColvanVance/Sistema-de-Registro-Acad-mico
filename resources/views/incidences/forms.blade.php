...
<div class="pl-lg-4">
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="form-group">
                <label class="form-control-label" for="departament_id"><i class="fa-solid fa-location-dot"></i> Departamento</label>
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <select name="type" id="type" class="form-control">
                    ...
                    <option value="Incidencias Previstas" {{ old('type', $incidences->type ?? '') == 'Incidencias Previstas' ? 'selected' : '' }}>Incidencias Previstas</option>
                    <option value="Incidencias Inprevistas" {{ old('type', $incidences->type ?? '') == 'Incidencias Inprevistas' ? 'selected' : '' }}>Incidencias Inprevistas</option>
                </select>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <select name="reasson" id="reasson" class="form-control">
                    ...
                    <option value="Vacaciones" {{ old('reasson', $incidences->reasson ?? '') == 'Vacaciones' ? 'selected' : '' }}>Vacaciones</option>
                    <option value="Incapacidad por maternidad" {{ old('reasson', $incidences->reasson ?? '') == 'Incapacidad por maternidad' ? 'selected' : '' }}>Incapacidad por maternidad</option>
                    <option value="Permisos solicitados" {{ old('reasson', $incidences->reasson ?? '') == 'Permisos solicitados' ? 'selected' : '' }}>Permisos solicitados</option>
                    <option value="Permisos solicitados" {{ old('reasson', $incidences->reasson ?? '') == 'Permisos solicitados' ? 'selected' : '' }}>Permisos solicitados</option>
                    <option value="Incapacidades por condiciones médicas específicas" {{ old('reasson', $incidences->reasson ?? '') == 'Incapacidades por condiciones médicas específicas' ? 'selected' : '' }}>Incapacidades por condiciones médicas específicas</option>
                    <option value="Horas extra" {{ old('reasson', $incidences->reasson ?? '') == 'Horas extra' ? 'selected' : '' }}>Horas extra</option>
                    <option value="Días económicos" {{ old('reasson', $incidences->reasson ?? '') == 'Días económicos' ? 'selected' : '' }}>Días económicos</option>
                    <option value="Accidentes laborales" {{ old('reasson', $incidences->reasson ?? '') == 'Accidentes laborales' ? 'selected' : ''}}>Accidentes laborales"></option>
                    <option value="Enfermedades repentinas" {{ old('reasson', $incidences->reasson ?? '') == 'Ausencias no planificadas' ? 'selected' : ''}}>Ausencias no planificadas"></option>
                    <option value="Retrasos" {{ old('reasson', $incidences->reasson ?? '') == 'Retrasos' ? 'selected' : ''}}>Retrasos"></option>
                    <option value="Incidencias de seguridad" {{ old('reasson', $incidences->reasson ?? '') == 'Incidencias de seguridad' ? 'selected' : ''}}>Incidencias de seguridad"></option>
                </select>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <select name="penalty" id="penalty" class="form-control">
                    ...
                    <option value="Amonestación" {{ old('penalty', $incidences->penalty ?? '') == 'Amonestación' ? 'selected' : '' }}>Amonestación</option>
                    <option value="Descuento" {{ old('penalty', $incidences->penalty ?? '') == 'Descuento' ? 'selected' : '' }}>Descuento</option>
                    <option value="Suspensión" {{ old('penalty', $incidences->penalty ?? '') == 'Suspensión' ? 'selected' : '' }}>Suspensión</option>
                    <option value="Otro..." {{ old('penalty', $incidences->penalty ?? '') == 'Otro...' ? 'selected' : '' }}>Otro...</option>
                </select>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <select name="status" id="status" class="form-control">
                    ...
                    <option value="Aprobado" {{ old('status', $incidences->status ?? '') == 'Amonestación' ? 'selected' : '' }}>Amonestación</option>
                    <option value="Desestimado" {{ old('status', $incidences->status ?? '') == 'Descuento' ? 'selected' : '' }}>Descuento</option>
                    <option value="En espera" {{ old('status', $incidences->status ?? '') == 'Suspensión' ? 'selected' : '' }}>Suspensión</option>
                </select>
            </div>
        </div>
    </div>
